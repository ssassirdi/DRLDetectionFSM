...
def main(args):
    ...
    try:
        os.mkdir("training/D3QNHeuristic/Data")
    except:
        pass
    ...
    for changedValue, runParameters, endRepetition in argGenerator.argsGenerate(plotArg=True):
        ...
        recorder = Recorder(actor.to("cpu"), optimizer, path + str(changedValue), [args.p])
        ...
        allZeta.append(copy.deepcopy(recorder.dataRecorded["zeta"]))
    ...
    with open(path + "resultData.pkl", "wb") as f:
        pkl.dump((allValueUsed, allMeanRolloutReward, allStateProportion, allEpisodeLength, allZeta), f)
